...
import { Upload as AntUpload, Button, message, Typography, Card } from "antd";
import { Upload, ArrowUpCircle, FileSpreadsheet } from "lucide-react";
    ...
    >
      <div className="flex flex-col gap-3 mt-3">
        <AntUpload
          ...
          maxCount={1}
        >
          <Button icon={<Upload className="w-4 h-4" />}>Choisir un fichier</Button>
        </AntUpload>
