        ...
        <form onSubmit={handleSubmit} className='space-y-8'>
          ...
          <div className='mt-6'>
            <div className='flex items-center mb-4'>
              ...
              <div
                className='ml-2 text-xs text-white bg-blue-500 rounded-full w-5 h-5 flex items-center justify-center cursor-help'
                title='Sélectionnez les rôles pour cet utilisateur'
              >
                ?
              </div>
            </div>
